...
import { FaPlay } from 'react-icons/fa'; // ⬅️ React icon
...
const MovieCard = ({ posterPath, title, id }) => {
  ...
  return (
    <div
      onClick={handleClick}
      className="group relative cursor-pointer rounded-2xl overflow-hidden shadow-md transition-transform duration-300 hover:scale-105 hover:z-10"
    >
      {/* Movie Poster */}
      <img
      ...
      <div className="absolute bottom-0 w-full px-4 pb-4 pt-2 translate-y-6 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 ease-in-out">
        ...
        {/* Watch Trailer */}
        <div className="flex items-center gap-2 mt-2 text-white text-sm font-medium">
