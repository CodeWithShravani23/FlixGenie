    ...
    <section className="relative h-screen bg-black flex flex-col justify-center items-center text-white overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl px-6">
        ...
        <motion.button
          ...
          className="bg-red-700 hover:bg-red-800 text-white font-bold py-3 px-8 rounded-full shadow-xl transition-all duration-300 hover:scale-105 text-lg flex items-center mx-auto"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
